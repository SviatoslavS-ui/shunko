...
public class ApiTest {
    ...
    public void privateBankTest() {
        ApiResourses.CurrencyValues[] currencyValues =
                given()
                ...
                .then()
                        ...
                        .log().all()
                        .extract()
                        .response().getBody().as(ApiResourses.CurrencyValues[].class);

        for (ApiResourses.CurrencyValues currencyElement : currencyValues) {
    ...
    public void demoQATestAlredyRegistered() {
        ...
        requestParams.put("UserName", "sdimpleuser2dd20555");
        requestParams.put("Password", "password");
